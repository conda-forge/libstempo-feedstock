...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libstempo-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libstempo-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `libstempo` available on your platform:
...
```
pixi search libstempo --channel conda-forge
```
